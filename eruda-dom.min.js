 ...
 */
/*! eruda-dom v2.0.0 https://github.com/liriliri/eruda-dom#readme */
! function (e, t) {
        ...
        return (0, y.default)(r, e), (0, f.default)(r, [{
          ...
          value: function (node, t) {
            var n = this,
              ...
              if (!node) {
                ...
                r = (node.shadowRoot) ? h(node.shadowRoot.childNodes) : h(node.childNodes);
                if (node.shadowRoot) {
                  console.log('ShadowRoot')
                  console.log(node.shadowRoot.childNodes)
                } else {
                  console.log('Not shadowRoot', node)
                }
              }
            var o = t.get(0);
            node && r.push({
          ...
          value: function (e, n) {
            ...
            if (u.addClass("eruda-tree-item"), e.nodeType === e.ELEMENT_NODE) {
              var l = e.shadowRoot ? e.shadowRoot.childNodes.length : e.childNodes.length,
                s = l > 0,
                c = (0, a.default)({}, t(e), {
                  hasTail: s
                }),
                f = 1 === l && (e.shadowRoot ? e.shadowRoot.childNodes[0].nodeType : e.childNodes[0].nodeType) === e.TEXT_NODE;
